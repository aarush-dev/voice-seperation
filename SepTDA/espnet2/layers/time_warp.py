...
Implements the "time warp" component of SpecAugment: a random local
time-axis warp applied to spectral features as a data-augmentation step
during training of the separation/ASR frontend.
"""
...
def time_warp(
    x: torch.Tensor, window: int = 80, mode: str = DEFAULT_TIME_WARP_MODE
) -> torch.Tensor:
